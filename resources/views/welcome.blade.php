<x-guest-layout>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach($recommendations as $rec)
                    ...
                    <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                        <img src="{{ $item->image ? Storage::url($item->image) : asset('images/default-menu.jpg') }}" alt="{{ $item->name }}" class="w-full h-40 object-cover">
                        <div class="p-4">
                            ...
                            <div class="flex justify-between items-center">
                                <span class="text-green-400 font-bold">Rp {{ number_format($item->price,0,',','.') }}</span>
  ...
  <section class="pt-4 pb-12 bg-gradient-to-br from-[#232526] via-[#1a1a2e] to-[#232526]">
    ...
    <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 px-4">
        <!-- Testimonial 1 -->
        <div class="max-w-md mx-auto p-6 rounded-xl shadow-lg bg-gradient-to-br from-[#2d3748] to-[#232526] border border-green-400">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-200 italic">"Makanannya enak, pelayanannya ramah, dan suasananya nyaman. Sangat recommended untuk keluarga!"</p>
            </div>
        ...
        <!-- Testimonial 2 -->
        <div class="max-w-md mx-auto p-6 rounded-xl shadow-lg bg-gradient-to-br from-[#2d3748] to-[#232526] border border-blue-400">
            <div class="flex justify-center -mt-16 mb-4">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-200 italic">"Menu variatif, harga terjangkau, dan tempatnya instagramable. Pasti balik lagi!"</p>
            </div>
            <div class="flex justify-end mt-4">
        ...
        <!-- Testimonial 3 -->
        <div class="max-w-md mx-auto p-6 rounded-xl shadow-lg bg-gradient-to-br from-[#2d3748] to-[#232526] border border-pink-400">
            <div class="flex justify-center -mt-16 mb-4">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-200 italic">"Tempat favorit buat nongkrong bareng teman. Wifi kencang, makanan cepat saji!"</p>
            </div>
            <div class="flex justify-end mt-4">
